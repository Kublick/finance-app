...
export const ImportCard = ({ data, onCancel, onSubmit }: Props) => {
  ...
  const handleContinue = () => {
    ...
    const arrayOfData = mappedData.body
      ...
      .filter(
        (item) => !isNaN(parseFloat(item.amount)) && item.amount !== null,
      );
    ...
    const formattedData = arrayOfData.map((item) => {
      ...
      return {
        ...
        date: parsedDate ? format(parsedDate, outputFormat) : undefined,
      };
    });
      ...
      <Card className="border-none drop-shadow-sm">
        ...
        <CardContent>
          <ImportTable
            ...
            onTableSelectedChange={onTableHeadSelectChange}
          />
        </CardContent>
      </Card>
    </div>
